...
(function() {
                    ...
                    if (!resolved) {
                        ...
                        switch(error.code) {
                            ...
                            case error.POSITION_UNAVAILABLE:
                                errorMessage += 'Position unavailable. Please check your GPS/WiFi connection.';
                                break;
                            case error.TIMEOUT:
    ...
    async function mobileFetch(url, options = {}, retryCount = 0) {
        ...
        const timeoutId = setTimeout(() => controller.abort(), MOBILE_CONFIG.api.timeout);
            ...
            if (retryCount < MOBILE_CONFIG.api.retryAttempts) {
                ...
                if (isNetworkError) {
                    ...
                    await new Promise(resolve =>
                        setTimeout(resolve, MOBILE_CONFIG.api.retryDelay * (retryCount + 1))
                    );
    ...
    function setupNetworkMonitoring() {
        ...
        function handleOffline() {
            showMobileAlert('No internet connection. Some features may be limited. 📱', 'warning', 8000);
        }
